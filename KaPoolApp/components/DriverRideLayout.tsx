          ...
          >
            <View className="mx-5 mt-10">
              ...
              <View className="mt-5">
                ...
                <TouchableOpacity
                  onPress={() => router.push("/(root)/(driver)/vehicle")}
                  className="flex-row items-center gap-3 py-2"
                >
                  <Ionicons
                    name="car-outline"
                ...
                <TouchableOpacity
                  onPress={() => router.push("/(root)/(driver)/ride")}
                  className="flex-row items-center gap-3 py-2"
                >
                  <Ionicons
                    name="map-outline"
                ...
                <TouchableOpacity
                  onPress={() => router.push("/(root)/(driver)/payment")}
                  className="flex-row items-center gap-3 py-2"
                >
                  <Ionicons
                    name="card-outline"
                ...
                <TouchableOpacity
                  onPress={() => router.push("/(root)/(driver)/review")}
                  className="flex-row items-center gap-3 py-2"
                >
                  <Ionicons
                    name="star-outline"
